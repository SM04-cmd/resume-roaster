  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .section-card { animation: fadeSlide 0.4s ease forwards; }
        .glitch-text { animation: ${glitch ? 'glitch 0.1s steps(1) 5' : 'none'}; }
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            {result.roast && (
              <div className="section-card" style={{
                ...
                <div style={{ fontSize: 11, color: "#FF3B3B", letterSpacing: 3, marginBottom: 12 }}>🔥 THE ROAST</div>
            ...
            <div style={{
              ...
              Share your roast score on LinkedIn 🔥
            </div>
          </div>
        )}
      </div>
